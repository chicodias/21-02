...
Sabe-se que para a distribuição do comprimento do bico dos pinguins tem-se que $\sigma = 3,34$ e a média $\theta = 48.8$ . 
...
Chegam duas amostras de bico de pinguins, uma com $n = 5$, outra com $n = 15$
