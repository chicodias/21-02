...
Neste trabalho, pudemos ver a forma das distribuições a *priori* e *posteriori* da média, com a variância conhecida, e da variância, com a média conhecida de uma distribuição Normal comportaram-se para diferentes valores de $n$, utilizando o conjunto de dados *palmerpenguins*. Foi uma aprendizagem interessante tanto do ponto de vista teórico quando prático, aqui procuramos elencar todo o nosso conhecimento acumulado em SME0809, e utilizá-lo para realizar a análise de um conjunto de dados reais utilizando a Inferência Bayesiana. Para próximos trabalhos teóricos nesse tópico, poderiam ser calculadas as distribuições preditivas, assim como as posterioris para o caso da *Gama* e da *Qui-Quadrado*.