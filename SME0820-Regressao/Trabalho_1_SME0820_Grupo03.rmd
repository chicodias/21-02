...
```{r read-load, warning=FALSE,message = FALSE, fig.cap= "Cinco primeiras observações do dataset"}
...
```{r summary, fig.cap = "Sumário das variáveis utilizadas"}
summary(dados %>% select(y,x1)) %>% kable()
```
