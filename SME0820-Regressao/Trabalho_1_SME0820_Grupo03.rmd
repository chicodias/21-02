...
```
 ...
 # Calculando o valor do coeficiente angular beta1
```{r}
b1_est <- Sxy/Sxx
```

 # Calculando o valor do intercepto beta0
```{r}
...
$$\widehat{Y}_i=1224.043-0.7769*X_i$$
