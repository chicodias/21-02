...
```
  ...
  Em um processo semelhante à testagem de $\beta_1$, com $\alpha$= 5% e os mesmos quantis, também é possível a constrção de nossa função de decisão. Se H0 não for rejeitado, temos que $\beta_0$ é estatisticamente igual a zero.
