...
Como contamos com  $h_{ii} = 0.1875$ para todos os valores da tabela, temos que os pontos se encontram com um afastamento uniforme da média. 
...
>>>>>>> ee29639face3efa390b1b29cee3927b4fa6a3a1b
...
pander(summary(ajuste_ponderado))
```
