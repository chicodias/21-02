...
author: "Grupo 13 - Francisco Miranda - 4402962 e Heitor Carvalho - 11833351"
...
* Faça um esboço do gráfico das distribuições a priori dos dois físicos em um mesmo sistema cartesiano.

Temos $\theta_A \sim N(900,20^2)$ e $\theta_B \sim N(900,80^2)$. Assim:
## Distribuição a priori da grandeza a ser estimada
```{distribuicoes a priori}
dados <- c(921.3429 910.8055 879.7302 899.3456 837.7587
